...
\begin{paracol}{2} % Begin the multi-column environment
  ...
  \workposition{depuis 2013} % tex-chktex 8 % Duration
  ...
  {Création d'une application de gestion de projets en chirurgie: formulaire sur mesure de collecte de données, statistiques, export. \\
    ...
    Bureau multi-plateforme {\small(\textit{jusqu'en 2018})}: \href{https://www.wxwidgets.org/}{wxWidgets} / \href{https://www.jhipster.tech/}{JHipster} / \href{https://www.postgresql.org/}{PostgreSQL}.} % Description
  ...
  {Logiciels de simulation open source: C, embarqué, Linux. \\
    ...
    \href{http://wsnet.gforge.inria.fr}{WSNet}: simulateur de réseaux de plateformes sans fils.} % Description
  ...
  \parbox[top][0.12\textheight][c]{\linewidth}{ % Parbox to hold the colour box; fixed height to match the name/CV text to the left, centred vertically and full line width
    ...
    \colorbox{shade}{ % Create the coloured box
      \begin{supertabular}{p{0.05\linewidth}|p{0.775\linewidth}} % Start a table with two columns, the table will ensure everything is aligned
        \raisebox{0pt}{\faMale} & 37 ans \\ % Age
  ...
  \begin{supertabular}{rl} % Start a table with two columns, the table will ensure everything is aligned
    ...
    \educationentry{2012 -- 2013} % tex-chktex 8 % Duration
    ...
    \educationentry{2000 -- 2006} % tex-chktex 8 % Duration
  ...
  \begin{supertabular}{rl} % Start a table with two columns, the table will ensure everything is aligned
    ...
    \tableentry{}{HTML, CSS,  Bash, Batch, Elisp,}{}
    \tableentry{}{Java}{spaceafter}
  ...
  \begin{supertabular}{rl} % Start a table with two columns, the table will ensure everything is aligned
    ...
    \tableentry{Autres}{Jardinage, bricolage, musique}{}
